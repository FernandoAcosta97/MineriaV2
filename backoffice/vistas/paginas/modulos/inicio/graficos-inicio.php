                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Estructuras</h5>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Contenido de la sección 1</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <div class="card-body">
                                    <h5 class="card-title">Sección 2</h5>
                                    <p class="card-text">Contenido de la sección 2</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Contenido de la sección 3</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <div class="card-body">
                                    <h5 class="card-title">Sección 4</h5>
                                    <p class="card-text">Contenido de la sección 4</p>
                                </div>
                            </div>
                        </div>
                    </div>
