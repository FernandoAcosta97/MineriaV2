          ...
          <div class="relative inline-block text-left" id="dropdown">
              <button type="button"
                  ...
                  <div class="flex gap-1 items-center">
                      <h1 class="text-primario">Movimientos Billetera</h1>
                      <span class="font-bold text-xl p-0 m-0 rotate text-primario">></span>
                  </div>
              </button>
          
              <div class="z-[200] origin-top-right absolute mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 hidden transition"
                  id="menu">
